...
const FALLBACK_DRIVERS: DriverListItem[] = [
  ...
  { id: "norris", name: "Lando Norris", code: "NOR", team: "McLaren", number: 4, pts: 15, wins: 0, podiums: 0, poles: 0, pos: 6, color: "#FF8000" },
  { id: "gasly", name: "Pierre Gasly", code: "GAS", team: "Alpine F1 Team", number: 10, pts: 9, wins: 0, podiums: 0, poles: 0, pos: 7, color: "#0093CC" },
  { id: "verstappen", name: "Max Verstappen", code: "VER", team: "Red Bull", number: 1, pts: 8, wins: 0, podiums: 0, poles: 0, pos: 8, color: "#3671C6" },
  { id: "lawson", name: "Liam Lawson", code: "LAW", team: "RB F1 Team", number: 30, pts: 8, wins: 0, podiums: 0, poles: 0, pos: 9, color: "#6692FF" },
  { id: "lindblad", name: "Arvid Lindblad", code: "LIN", team: "RB F1 Team", number: 40, pts: 4, wins: 0, podiums: 0, poles: 0, pos: 10, color: "#6692FF" },
  { id: "hadjar", name: "Isack Hadjar", code: "HAD", team: "Red Bull", number: 20, pts: 4, wins: 0, podiums: 0, poles: 0, pos: 11, color: "#3671C6" },
